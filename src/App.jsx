        ...
        >
            ...
            <div className="tx-amount-row">
                <span className="tx-amount" style={{ color: meta.color }}>
                    {(typeKey === 'DEBIT' || typeKey === 'WITHDRAW' ? '−' : '+')}
                    ZMW {Number(tx.amount || 0).toFixed(2)}
                </span>
        ...
        <div className="statement-card">
            ...
            {balanceMatch && (
                <div className="statement-balance-block">
                    ...
                    <strong>ZMW {Number(balanceMatch[1].replace(/,/g, '')).toFixed(2)}</strong>
                </div>
            )}
...
// ✅ FIXED: moved outside App so it does not remount on every keystroke
const SimpleFormPage = ({ title, desc, onSubmit, children }) => (
    <section className="single-page-card">
        ...
        <form onSubmit={onSubmit} className="single-form">
            {children}
        </form>
    </section>
)
...
function App() {
    ...
    useEffect(() => {
        if (activeAccountId) {
            localStorage.setItem('zedpay_active_account_id', activeAccountId)
        } else {
    ...
    const syncUserData = async (userId, silent = true) => {
        ...
        try {
            ...
            if (freshAccounts.length > 0) {
                ...
                const accountToUse = stillExists ? activeAccountId : freshAccounts[0].id
            ...
            if (!silent) {
                showError(err.response?.data?.message || 'Failed to refresh user data')
            }
            return null
        }
    }
    ...
    const createAccount = async (e) => {
        ...
        try {
            ...
            if (syncResult?.accounts?.length) {
                ...
                if (newest?.id) {
                    setActiveAccountId(newest.id)
                    applyActiveAccountEverywhere(newest.id)
                }
            }
    ...
    const sendMoney = async (e) => {
        ...
        try {
            ...
            if (res.data?.summary) {
                setHistory((prev) => [res.data.summary, ...prev].slice(0, 10))
            }
    ...
    useEffect(() => {
        if (isLoggedIn && loggedInUser?.id) {
            syncUserData(loggedInUser.id, true)
        }
    }, [isLoggedIn])
    ...
    const copyAccountId = async (accountId) => {
        if (!accountId) {
            showError('No account ID available to copy')
            return
        }
        ...
        try {
            ...
            showError('Failed to copy account ID')
        }
    }
    ...
    const renderPage = () => {
                ...
                <>
                    <section className="home-hero">
                        <div className="home-hero-text">
                            ...
                            <p>
                                Manage balances, send money, withdraw, and view your own account records in a secure
                                end-user interface.
                            </p>
                                    ...
                                    {myAccounts.map((account) => (
                                        <div
                                            ...
                                            className={`snapshot-item ${
                                                activeAccountId === account.id ? 'selected-snapshot-item' : ''
                                            }`}
                                        >
                                            <div>
                                        ...
                                        {profileAccounts.map((account) => {
                                            ...
                                            return (
                                                <button
                                                    key={account.id}
                                                    type="button"
                                                    className={`wallet-card wallet-card-selectable ${
                                                        isActive ? 'active-wallet-card' : ''
                                                    }`}
                                                ...
                                                >
                                                    ...
                                                    <div className="account-id-copy-row">
                                                        ...
                                                        <span
                                                            className="copy-btn small-copy-btn"
                                                            onClick={(e) => {
                                                                e.stopPropagation()
                                                    ...
                                                    <p>
                                                        <strong>Owner:</strong> {account.ownerId}
                                                    </p>

                                                    {account.accountType === 'SAVINGS' &&
                                                        account.minimumBalance !== undefined && (
                                                            <p>
                                                                <strong>Min Balance:</strong> ZMW{' '}
                                                                {Number(account.minimumBalance).toFixed(2)}
                                                            </p>
                                                        )}
                    ...
                    <form onSubmit={createAccount} className="single-form">
                        <div className="form-group">
                            ...
                            <input
                                ...
                                onChange={mkChange(setAccountForm)}
                            />
                        </div>
        ...
        if (currentPage === 'topup') {
            return (
                <SimpleFormPage
                    title="Add Balance"
                    desc="Top up your selected account or enter any account ID."
                ...
                >
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={mkChange(setTopUpForm)}
                        />
                    </div>
        ...
        if (currentPage === 'withdraw') {
            return (
                <SimpleFormPage
                    ...
                    desc="Withdraw from your selected account or enter any account ID."
                ...
                >
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={mkChange(setWithdrawForm)}
                        />
                    </div>
        ...
        if (currentPage === 'send-money') {
            return (
                <SimpleFormPage
                    title="Send Money"
                    desc="Transfer funds from your selected account to another."
                    onSubmit={sendMoney}
                >
                    <div className="form-group">
                        ...
                        <input
                            ...
                            onChange={mkChange(setSendMoneyForm)}
                        />
                    </div>
            ...
            return (
                <section className="single-page-card">
                    ...
                    <div className="lookup-row">
                        ...
                        />
                        <button type="button" onClick={loadStatementAndHistory} disabled={loading}>
            ...
            <div className="login-screen">
                <div className="login-left">
                    ...
                    <div className="login-copy">
                        ...
                        <h2>
                            Welcome to <span>ZedPay</span>
                        </h2>
                        <p>
                            Access your wallet dashboard, manage balances, send money, and view only your own records
                            — all in one place.
                        </p>
                            ...
                            <form onSubmit={handleLogin} className="single-form">
                                <div className="form-group">
                                    ...
                                    <input
                                        ...
                                        onChange={mkChange(setLoginForm)}
                                    />
                                </div>
                                ...
                                {[
                                    ...
                                    <div key={name} className="form-group">
                                        ...
                                        <input
                                            ...
                                            onChange={mkChange(setRegisterForm)}
                                        />
                                    </div>
                                ))}
        ...
        <div className="app-shell app-shell-redesigned">
            <aside className="sidebar">
                ...
                <div className="sidebar-card">
                    ...
                    <p>
                        <span>User</span>
                        <strong>{loggedInUser?.fullName?.split(' ')[0] || '—'}</strong>
                    </p>
                    <p>
                        <span>Active</span>
